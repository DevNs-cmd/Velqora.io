...
const menuItems = [
  ...
  { name: 'Profile & Portfolio', href: '/artist/profile', icon: UserCircle },
  { name: 'Request Feed', href: '/artist/feed', icon: Search },
  { name: 'My Offers', href: '/artist/offers', icon: MessageSquare },
  { name: 'Earnings', href: '/artist/earnings', icon: DollarSign },
          ...
          <div className="pt-8 border-t border-gold/10 space-y-4">
             <div className="flex items-center space-x-4">
                ...
                <div className="flex flex-col overflow-hidden">
                   ...
                   <span className="text-[10px] text-gold font-bold uppercase tracking-widest uppercase">Verified Artist</span>
                </div>
             </div>
             <button
        ...
        <header className="h-20 bg-charcoal-dark/50 backdrop-blur-md border-b border-gold/10 sticky top-0 z-30 px-6 sm:px-10 flex items-center justify-between">
           <div className="flex items-center space-x-4">
              ...
              <h2 className="text-xl font-serif font-bold text-white lg:block hidden">
                 Artist <span className="text-gold italic">Lounge</span>
              </h2>
           </div>

           <div className="flex items-center space-x-6">
              <div className="hidden sm:flex items-center space-x-2 px-4 py-2 bg-gold/10 border border-gold/20 rounded-full">
                 <Sparkles size={14} className="text-gold" />
                 <span className="text-[10px] font-bold uppercase tracking-widest text-gold-light">Response Time: 2h</span>
              </div>
